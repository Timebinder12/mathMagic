        ...
        private static void rightFeedback()
        {
            ...
            switch (num)
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    Console.WriteLine("I think the tutor needs to take lessons from you.");
                    break;
                case 4:
                    Console.WriteLine("Easy now, brainiac!");
                    break;
                case 5:
                    Console.WriteLine("I'll just call you Jimmy Neutron!");
                    break;
                case 6:
                    Console.WriteLine("Awesome!");
                    break;
                case 7:
                    Console.WriteLine("You made me look up synononms in the Thesaurus for great because that's how great you are!");
                    break;
                default:
